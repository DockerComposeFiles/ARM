...
def bmp180():
    ...
    if bmp180_scan == "0x00":
        ...
        print("bmp180 no connection by 589", flush=True)

    else:
        print("bmp180 no connection: unknown message", flush=True)
...
def bmp280():
    ...
    if bmp280_scan == "0x00":
        ...
        print("bmp180 no connection by 588", flush=True)

    else:
        print("bmp280 no connection: unknown message", flush=True)
